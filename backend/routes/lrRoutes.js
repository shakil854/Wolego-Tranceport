...
// Get all LRs (Sorted numerically by LR Number DESCENDING e.g. 6, 5, 4, 3, 2, 1)
router.get("/", async (req, res) => {
  try {
    ...
    lrs.sort((a, b) => {
      ...
      return String(b.lrNumber || "").localeCompare(String(a.lrNumber || ""), undefined, { numeric: true, sensitivity: "base" });
    });
    res.json(lrs);
  } catch (err) {
