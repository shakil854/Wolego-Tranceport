      ...
      <div class="relative z-10 flex-1 flex flex-col justify-between">
        ...
        <div class="border-b-2 border-slate-900 p-2.5 pb-2">
          ...
          <div class="grid grid-cols-12 gap-1 items-center my-1">
            ...
            <!-- Middle Column: Exact 8-Line Sequence -->
        ...
        <div class="grid grid-cols-12 border-b-2 border-slate-900 font-black text-[11px] divide-x-2 divide-slate-900 text-slate-950">
          <div class="col-span-3 p-1.5 bg-slate-100 flex items-center justify-center gap-2">
            <span>L.R. NO. :</span>
            <span class="text-base font-black text-rose-700 font-mono">${lrData.lrNumber || ""}</span>
          </div>
          <div class="col-span-3 p-1.5 flex items-center gap-2">
            <span>DATE :</span>
            <span class="font-black text-[11px]">${formatDateDisplay(lrData.dateTime)}</span>
          </div>
          <div class="col-span-3 p-1.5 flex items-center gap-2">
            <span>FROM :</span>
            <span class="uppercase font-black text-[11px] text-slate-950">${lrData.fromPlace || ""}</span>
          </div>
          <div class="col-span-3 p-1.5 flex items-center gap-2">
            <span>TO :</span>
            <span class="uppercase font-black text-[11px] text-slate-950">${lrData.toPlace || ""}</span>
          </div>
        </div>
        ...
        <div class="grid grid-cols-12 divide-x-2 divide-slate-900 flex-1 min-h-[400px]">
          ...
          <div class="col-span-5 bg-transparent flex flex-col justify-between font-sans text-[11px] font-black h-full text-slate-950">
            ...
            <div class="my-auto pt-3.5 pb-1 flex items-center justify-center flex-1 w-full px-2 overflow-hidden">
              ${
                logoBase64
                  ? `<img src="${logoBase64}" alt="Wolego Transport Logo" class="w-full max-w-[260px] h-auto max-h-[200px] object-contain mix-blend-multiply opacity-95" style="clip-path: inset(0 0 18% 0); transform: scale(1.1);" />`
                  : ""
              }
            </div>
